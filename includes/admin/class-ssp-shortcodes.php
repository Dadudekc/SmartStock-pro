...
class SSP_Shortcodes {
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                form.addEventListener('submit', async (e) => {
                    ...
                    const security = form.querySelector('[name="security"]').value;
                    ...
                    try {
                        const response = await fetch('<?php echo admin_url('admin-ajax.php'); ?>', {
                            ...
                            body: new URLSearchParams({ action: 'ssp_fetch_stock_data', symbol, security })
                        });
    ...
    public static function alert_setup_shortcode(): string {
        ...
        <form id="ssp-alert-setup-form">
            ...
            <input type="text" id="alert-value" name="alert-value" placeholder="e.g., 120" required>
            <input type="hidden" name="security" value="<?php echo esc_attr($nonce); ?>">
